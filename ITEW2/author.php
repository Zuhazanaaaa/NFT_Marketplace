...
<html lang="en">
  <head>
    ...
    <title>Liberty NFT - Dashboard</title>
          ...
          <div class="col-12">
            <nav class="main-nav">
              ...
              <li><a href="index.php">Home</a></li>
                ...
                <li><a href="author.php" class="active">Dashboard</a></li>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6">
            <div class="author">
              <img
                src="assets/images/single-author.jpg"
                alt=""
          ...
          <div class="col-lg-6">
            <div class="right-info">
              ...
              <div class="row">
                ...
                <div class="col-7">
                  <div class="main-button">
                    <a href="https://www.instagram.com/leomar.esc/">Follow @docleo</a>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="col-lg-12">
                  ...
                  <div class="row">
                    <div class="col-6">
                      <span
                        >Current Bid: <br />
                        <strong>2.03 ETH</strong></span
                      >
                    </div>
                    <div class="col-6">
                      <span
                        >Ends In: <br />
                        <strong>25th Nov</strong></span
                      >
                    </div>
                  </div>
                </div>
