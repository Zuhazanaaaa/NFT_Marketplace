        ...
        <div class="row">
          <div class="col-lg-6 align-self-center">
            <div class="header-text">
              ...
              <p>
              "Liberty NFT Market offers a sleek and professional design, tailored for creating modern NFT platforms. Our marketplace template combines cutting-edge aesthetics with user-friendly functionality, ensuring a seamless experience for all. Build your NFT site with the best tools to showcase and trade digital assets effortlessly."
              </p>
              <div class="buttons">
                  ...
                  <div class="owl-collection owl-carousel">
                    <div class="item">
                      ...
                      <div class="down-content">
                        ...
                        <span class="collection"
                          >Items In Collection:<br /><strong
                            >310/340</strong
                          ></span
                        >
                        <span class="category"
                          >Category:<br /><strong>Digital Crypto</strong></span
                        >
                        <div class="main-button">
                    ...
                    <div class="item">
                      ...
                      <div class="down-content">
                        ...
                        >
                        <span class="category"
                          >Category:<br /><strong>Visual Art</strong></span
                        >
                        <div class="main-button">
                    ...
                    <div class="item">
                      ...
                      <div class="down-content">
                        ...
                        >
                        <span class="category"
                          >Category:<br /><strong>Music Art</strong></span
                        >
                        <div class="main-button">
                    ...
                    <div class="item">
                      ...
                      <div class="down-content">
                        ...
                        >
                        <span class="category"
                          >Category:<br /><strong>Blockchain</strong></span
                        >
                        <div class="main-button">
            ...
            <div class="item second-item">
              ...
              Easily showcase and add your digital NFTs with our platform, designed for seamless uploading and management to maximize your visibility in the marketplace.
                <a
                  ...
                  rel="nofollow"
                  >website tech</a
                >. You can visit this IT Tech for needed assistance.
              </p>
            </div>
          </div>
          <div class="col-lg-4">
              ...
              <div class="col-lg-6 currently-market-item all msc">
                <div class="item">
                  ...
                  <div class="right-content">
                    ...
                    <div class="line-dec"></div>
                    <span class="bid">
                      Current Bid<br /><strong>2.03 ETH</strong><br /><em
                        >($8,240.50)</em
                      >
                    </span>
                    <span class="ends">
                      Ends In<br /><strong>4D 08H 15M 42S</strong><br /><em
                        >(July 24th, 2024)</em
                      >
                    </span>
              ...
              <div class="col-lg-6 currently-market-item all dig">
                <div class="item">
                  ...
                  <div class="right-content">
                    ...
                    <span class="ends">
                      Ends In<br /><strong>2D 06H 30M 25S</strong><br /><em
                        >(July 26th, 2024)</em
                      >
                    </span>
                    <div class="text-button">
              ...
              <div class="col-lg-6 currently-market-item all blc">
                <div class="item">
                  ...
                  <div class="right-content">
                    ...
                    <div class="line-dec"></div>
                    <span class="bid">
                      Current Bid<br /><strong>3.64 ETH</strong><br /><em
                        >($6,600.00)</em
                      >
                    </span>
                    <span class="ends">
                      Ends In<br /><strong>6D 05H 40M 50S</strong><br /><em
                        >(July 28th, 2024)</em
                      >
                    </span>
                    <div class="text-button">
              ...
              <div class="col-lg-6 currently-market-item all vtr">
                <div class="item">
                  ...
                  <div class="right-content">
                    ...
                    <div class="line-dec"></div>
                    <span class="bid">
                      Current Bid<br /><strong>2.44 ETH</strong><br /><em
                        >($8,800.50)</em
                      >
                    </span>
                    <span class="ends">
              ...
              <div class="col-lg-6 currently-market-item all vrt dig">
                <div class="item">
                  ...
                  <div class="right-content">
                    ...
                    <div class="line-dec"></div>
                    <span class="bid">
                      Current Bid<br /><strong>2.50 ETH</strong><br /><em
                        >($8,400.50)</em
                      >
                    </span>
                    <span class="ends">
                      Ends In<br /><strong>4D 08H 32M 18S</strong><br /><em
                        >(July 16th, 2024)</em
                      >
                    </span>
                    <div class="text-button">
              ...
              <div class="col-lg-6 currently-market-item all msc blc">
                <div class="item">
                  ...
                  <div class="right-content">
                    ...
                    <span class="ends">
                      Ends In<br /><strong>5D 10H 22M 24S</strong><br /><em
                        >(July 18th, 2024)</em
                      >
                    </span>
                    <div class="text-button">
